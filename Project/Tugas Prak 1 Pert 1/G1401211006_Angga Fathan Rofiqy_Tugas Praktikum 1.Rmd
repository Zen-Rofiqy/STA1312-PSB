...
-   Sementara nilai $\theta$ yang lebih besar, misalkan saat $\theta=0.5$ cenderung membuat nilai $n$ yang lebih besar dibandingkan saat $\theta=0.2$. Hal ini menunjukkan saat peluang untuk membeli jika pelanggan dateng ke toko ($\theta$) lebih tinggi, sebaran posterior akan menunjukkan peluang yang lebih tinggi untuk nilai n.
