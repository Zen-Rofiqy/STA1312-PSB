...
-   Ketika <mark style="background-color: #b6f2b6">nilai $Y$ kecil</mark>, misalkan saat $Y=0$, sebaran posterior cenderung berepusat di nilai <mark style="background-color: #b6f2b6">n yang lebih kecil</mark>. \
    Hal ini menunjukkan <mark style="background-color: #b6f2b6">jika sangat sedikit pelanggan yang membel`i</mark>`{=html} ($Y$), kemungkinan banyaknya <mark style="background-color: #b6f2b6">pelanggan yang dateng ke toko pada hasi diskon juga akan sediki`t</mark>`{=html}.
